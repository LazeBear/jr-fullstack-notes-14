...
Promise.resolve().then(()=>console.log(5)).catch(()=>console.log(5.1));
Promise.resolve().catch(()=>console.log(6)).then(()=>console.log(6.1));
Promise.reject().then(()=>console.log(7)).catch(()=>console.log(7.1));
Promise.reject().catch(()=>console.log(8)).then(()=>console.log(8.1));
```
...
setTimeout(()=>{
  ...
  new Promise((res,rej)=>{
    ...
    rej();
  }).then(()=>console.log(3.3)).catch(()=>console.log(3.4));
});
